...
import net.yasinger.aircraftmod.entity.flyingsword.FlySwordModel;
...
public class ClientEventHandler {
    ...
    public static void registerEntityLayers(EntityRenderersEvent.RegisterLayerDefinitions event) {
        event.registerLayerDefinition(FlySwordModel.LAYER_LOCATION, FlySwordModel::createBodyLayer);
    }
    @SubscribeEvent
